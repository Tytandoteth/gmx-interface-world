...
import { ARBITRUM, AVALANCHE, AVALANCHE_FUJI, WORLD } from "sdk/configs/chains";

export * from "sdk/configs/chains";

export const FEES_HIGH_BPS = 50;

export type ChainId = typeof AVALANCHE | typeof AVALANCHE_FUJI | typeof ARBITRUM | typeof WORLD;
